...
public class Expr_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "Expr", new SNodePointer("r:03a898a7-fc22-4755-8556-58301e273720(FunLanguage.editor)", "4480776280326385037")));
    try {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Param_e1zeix_a0());
    }
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Param_e1zeix_a1());
    }
    return result;
  }
  ...
  private class TMP_Param_e1zeix_a0 extends ParameterizedMenuPart<SConcept, TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<TransformationMenuItem> createItems(SConcept parameter, TransformationMenuContext context) {
      return new TMP_Action_e1zeix_a0a(parameter).createItems(context);
    }
    ...
    private class TMP_Action_e1zeix_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      public TMP_Action_e1zeix_a0a(SConcept parameterObject) {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        ...
        context.getEditorMenuTrace().pushTraceInfo();
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:03a898a7-fc22-4755-8556-58301e273720(FunLanguage.editor)", "4480776280326390164")));
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          SNode bin = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(myParameterObject));
          SNodeOperations.replaceWithAnother(_context.getNode(), bin);
          SLinkOperations.setTarget(bin, LINKS.left$WBNK, _context.getNode());
          SelectionUtil.selectCell(_context.getEditorContext(), bin, SelectionManager.LAST_CELL);
        }
  ...
  private class TMP_Param_e1zeix_a1 extends ParameterizedMenuPart<SConcept, TransformationMenuItem, TransformationMenuContext> {
    ...
    @Override
    protected List<TransformationMenuItem> createItems(SConcept parameter, TransformationMenuContext context) {
      return new TMP_Action_e1zeix_a0b(parameter).createItems(context);
    }
    ...
    private class TMP_Action_e1zeix_a0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      private final SConcept myParameterObject;
      public TMP_Action_e1zeix_a0b(SConcept parameterObject) {
        myParameterObject = parameterObject;
      }
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        ...
        context.getEditorMenuTrace().pushTraceInfo();
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:03a898a7-fc22-4755-8556-58301e273720(FunLanguage.editor)", "4480776280326647463")));
          item.setTraceInfo(context.getEditorMenuTrace().getTraceInfo());
        } finally {
          context.getEditorMenuTrace().popTraceInfo();
        }
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          SNode bin = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(myParameterObject));
          SNodeOperations.replaceWithAnother(_context.getNode(), bin);
          SLinkOperations.setTarget(bin, LINKS.right$WChM, _context.getNode());
          SelectionUtil.selectCell(_context.getEditorContext(), bin, SelectionManager.FIRST_CELL);
        }
