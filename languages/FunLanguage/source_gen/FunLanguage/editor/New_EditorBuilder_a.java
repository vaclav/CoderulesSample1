...
/*package*/ class New_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public New_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_bn5pqu_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_bn5pqu_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.structDefinition$Ux5K;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.structDefinition$Ux5K);
    ...
    provider.setNoTargetText("<no structDefinition>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.structDefinition$Ux5K);
    }
