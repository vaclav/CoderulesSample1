...
public class _RecoverType_Default__ruleTable extends AbstractRuleTable implements RuleTable {

  protected _RecoverType_Default__ruleTable(AbstractCoderulesManifest manifest) {
    super(manifest);
    init();
  }
  ...
  @Override
  public String name() {
    return "_RecoverType_Default_";
  }

  @Override
  public String fqName() {
    return "NewLanguage.types._RecoverType_Default_";
  }
