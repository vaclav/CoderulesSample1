    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Expression1() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().expr, token().expr, SNodePointer.deserialize("1e1cb32f-f351-4779-8474-7f95498558c8/i:10000006(FunLanguage@transient0/FunLanguage.types@3_4)/1942659408248973317"), new Function<ExpandMacroTemplate.Token, RuleBuilder>() {
