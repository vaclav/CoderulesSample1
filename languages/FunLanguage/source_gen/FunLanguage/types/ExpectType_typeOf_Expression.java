    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Expression1() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().expr, token().expr, SNodePointer.deserialize("8c45ba75-276a-4f03-80af-86a89d8b6d37/i:10000057(FunLanguage@transient0/FunLanguage.types@3_2)/6305976777216429990"), new Function<ExpandMacroTemplate.Token, RuleBuilder>() {
