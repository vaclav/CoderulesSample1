...
public class ExpectType_typeOf_Definition extends AbstractRuleTemplate<ExpectType_typeOf_Definition.Token> {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Definition1() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().def, token().def, "FunLanguage.types._expectType_", (ExpandMacroTemplate.Token tok) -> tok.withLogical(rule().Type).withParams(session.getParameter("class jetbrains.mps.coderules.typechecking.service.TypecheckingState.TypesCollector", Object.class)).apply()));
  ...
  public ExpectType_typeOf_Definition(RuleTable ruleTable) {
    super(ruleTable, "typeOf_Definition", "FunLanguage.types.typeOf_Definition", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(FunLanguage.types)/9107496436260758626"));
  }
