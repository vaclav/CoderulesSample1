...
public class ExpectType_typeOf_Definition extends AbstractRuleTemplate<ExpectType_typeOf_Definition.Token> {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Definition() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().def, token().def, SNodePointer.deserialize("fd780ef4-be4d-4253-b77e-de0d0be4819f/i:1000005a(NewLanguage@transient0/NewLanguage.types@4_6)/2574515577635558443"), new Function<ExpandMacroTemplate.Token, RuleBuilder>() {
  ...
  public ExpectType_typeOf_Definition(RuleTable ruleTable) {
    super(ruleTable, "typeOf_Definition", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(NewLanguage.types)/9107496436260758626"));
  }
