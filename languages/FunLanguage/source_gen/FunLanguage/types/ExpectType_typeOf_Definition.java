    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Definition1() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().def, token().def, SNodePointer.deserialize("82ca9abf-19c4-411c-b637-f306c9b4bb1d/i:10000006(FunLanguage@transient12/FunLanguage.types@3_4)/3953395691054926763"), new Function<ExpandMacroTemplate.Token, RuleBuilder>() {
