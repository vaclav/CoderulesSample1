    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Definition1() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().def, token().def, SNodePointer.deserialize("5a78b1b2-d817-42b2-b1fa-240a7b825d0c/i:10000054(FunLanguage@transient0/FunLanguage.types@3_2)/6066286926828963292"), (ExpandMacroTemplate.Token tok) -> tok.withLogical(rule().Type).withParams(session.getParameter(TypecheckingState.TYPES_COLLECTOR, Object.class)).apply()));
