    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Definition() {
        ...
        public void apply(final TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().def, token().def, SNodePointer.deserialize("3fdf02b2-056d-4611-906b-e822f023f9ad/i:1000005a(FunLanguage@transient3/FunLanguage.types@4_6)/8985241905649521804"), new Function<ExpandMacroTemplate.Token, RuleBuilder>() {
