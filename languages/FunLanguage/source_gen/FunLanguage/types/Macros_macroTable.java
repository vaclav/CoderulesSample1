...
public class Macros_macroTable extends AbstractMacroTable {
  ...
  public String getFqName() {
    return "FunLanguage.types.Macros";
  }
  ...
  public <T extends CallMacroTemplate.Token> CallMacroTemplate<T> callMacroTemplate(String templateFqn) {
    ...
    switch (templateFqn) {
      case "FunLanguage.types.make_Float_Type":
  ...
  public static class ConstantArrayType_5736138219386146136_Expand extends AbstractMacroTemplate<ConstantArrayType_5736138219386146136_Expand.Token> implements ExpandMacroTemplate<ConstantArrayType_5736138219386146136_Expand.Token> {
    ...
    public static class Token implements ExpandMacroTemplate.Token {
      ...
      public RuleBuilder apply() {
        ...
        builder.merge(0, _session.expandMacro(token().ruleInput, SLinkOperations.getTarget(macroInput, LINKS.elementType$Xq3i), "FunLanguage.types.lift", (ExpandMacroTemplate.Token tok) -> tok.withLogical(Token.this.ComponentType).withParams().apply()));
