...
public class _RecoverType___recover_intType extends AbstractRuleTemplate<_RecoverType___recover_intType.Token> {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new _recover_intType() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          RuleBuilder builder = new RuleBuilder(session, "_recover_intType", "_recover_intType", getTemplateRef(), null, SNodeOperations.getPointer(null));

          builder.appendHeadReplaced(new ConstraintBuilder(new ConstraintSymbol("__recoverType__", 2)).withArguments(rule().Type, (new MyTypes_termTable.intType_term(true) {
            public DataForm val() {
  ...
  public _RecoverType___recover_intType(RuleTable ruleTable) {
    super(ruleTable, "_recover_intType", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(NewLanguage.types)/5057411498114695448"));
  }
