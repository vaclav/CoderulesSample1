    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new stringLiteral() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          builder.merge(0, session.expandMacro(token().s, token().s, SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(FunLanguage.types)/7475035771484099126"), new Function<ExpandMacroTemplate.Token, RuleBuilder>() {
