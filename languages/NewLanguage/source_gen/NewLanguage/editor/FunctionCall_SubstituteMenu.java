...
public class FunctionCall_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for FunctionCall. Generated from implicit smart reference attribute.", new SNodePointer("r:be043769-47e7-46c7-b335-bc777f9c75cb(NewLanguage.structure)", "3711979631469947961")));
    try {
  ...
  public class SMP_ReferenceScope_qi4up_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_qi4up_a() {
      ...
      super((SAbstractConcept) CONCEPTS.FunctionCall$zZ, LINKS.target$SiaI);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_qi4up_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.FunctionCall$zZ);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "FunctionCall", null));
      try {
        return super.createItems(context);
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
