...
public class VarReference_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for VarReference. Generated from implicit smart reference attribute.", new SNodePointer("r:be043769-47e7-46c7-b335-bc777f9c75cb(NewLanguage.structure)", "813836719656510265")));
    try {
  ...
  public class SMP_ReferenceScope_a5loq2_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_a5loq2_a() {
      ...
      super((SAbstractConcept) CONCEPTS.VarReference$bV, LINKS.declaration$bZ6g);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_a5loq2_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.VarReference$bV);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
