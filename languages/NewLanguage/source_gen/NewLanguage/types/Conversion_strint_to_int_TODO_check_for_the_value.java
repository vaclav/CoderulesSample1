...
public class Conversion_strint_to_int_TODO_check_for_the_value extends AbstractRuleTemplate<Conversion_strint_to_int_TODO_check_for_the_value.Token> {
  ...
  public class Token implements RuleTemplate.Token {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new strint_to_int_TODO_check_for_the_value() {
        @Override
        public void apply(TemplateApplicationSession session) {
          A = MetaLogicalFactory.metaLogical("A", DataForm.class);
          B = MetaLogicalFactory.metaLogical("B", DataForm.class);

          RuleBuilder builder = new RuleBuilder(session, "strint_to_int_TODO_check_for_the_value", "strint_to_int_TODO_check_for_the_value", getTemplateRef(), null, SNodeOperations.getPointer(null));

          builder.appendHeadReplaced(new ConstraintBuilder(new ConstraintSymbol("convertsTo", 2)).withArguments((new MyTerms_termTable.stringType_term(true)).getTerm(), (new MyTerms_termTable.intType_term(true)).getTerm()).withPatternLogicals(rule().A, rule().B).toConstraint());
          builder.appendBody(new PredicateBuilder(FailPredicate.FAIL_SYM).withArguments(new LateExpression<Object>() {
            ...
            public Object eval(LogicalContext _logicalContext, InvocationContext _invocationContext, Object... args) {
              ...
              return "Error converting string to int";
            }
          }).toPredicate());
    ...
    public abstract class strint_to_int_TODO_check_for_the_value implements ConstraintRuleTemplate {

      protected strint_to_int_TODO_check_for_the_value rule() {
        return this;
      }
  ...
  public Conversion_strint_to_int_TODO_check_for_the_value(RuleTable ruleTable) {
    super(ruleTable, "strint_to_int_TODO_check_for_the_value", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(NewLanguage.types)/813836719656064843"));
  }
