...
public class Check_constantDefinition extends AbstractRuleTemplate<Check_constantDefinition.Token> {
  ...
  public class Token implements RuleTemplate.Token {
    ...
    public abstract class constantDefinition implements ConstraintRuleTemplate {

      protected constantDefinition rule() {
        return this;
      }
  ...
  public Check_constantDefinition(RuleTable ruleTable) {
    super(ruleTable, "constantDefinition", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(NewLanguage.types)/1749218580158264298"));
  }
