...
public class ExpectType_typeOf_Type extends AbstractRuleTemplate<ExpectType_typeOf_Type.Token> {
  ...
  public class Token implements RuleTemplate.Token {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_Type() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          RuleBuilder builder = new RuleBuilder(session, "typeOf_Type", "typeOf_Type#0" + "_" + String.valueOf(token().type_def.getNodeId()).replaceAll("~", "_"), getTemplateRef(), token().type_def, SNodeOperations.getPointer(token().type_def));
          ...
          builder.appendHeadKept(new ConstraintBuilder(new ConstraintSymbol("typeOf", 2)).withArguments(token().type_def, rule().TypeTerm).toConstraint());
          ...
          builder.appendBody(new PredicateBuilder(EvalExpressionPredicate.EVAL_SYM).withArguments(new LateExpression<Object>() {
            public Object[] metaArgs() {
              return new Object[]{rule().TypeCollector, rule().TypeNode, token().type_def};
            }
      ...
      new typeOf_Type1() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          RuleBuilder builder = new RuleBuilder(session, "typeOf_Type", "typeOf_Type#1" + "_" + String.valueOf(token().type_def.getNodeId()).replaceAll("~", "_"), getTemplateRef(), token().type_def, SNodeOperations.getPointer(token().type_def));

          builder.appendHeadReplaced(new ConstraintBuilder(new ConstraintSymbol("expectType", 2)).withArguments(token().type_def, rule().TypeCollector).toConstraint());
          builder.appendHeadKept(new ConstraintBuilder(new ConstraintSymbol("typeOf", 2)).withArguments(token().type_def, rule().TypeTerm).toConstraint());
          builder.appendBody(new ConstraintBuilder(new ConstraintSymbol("recover", 2)).withArguments(rule().TypeNode, rule().TypeTerm).toConstraint());
          builder.appendBody(new PredicateBuilder(EvalExpressionPredicate.EVAL_SYM).withArguments(new LateExpression<Object>() {
            public Object[] metaArgs() {
    ...
    public abstract class typeOf_Type implements ConstraintRuleTemplate {

      protected typeOf_Type rule() {
        return this;
      }
    ...
    public abstract class typeOf_Type1 implements ConstraintRuleTemplate {

      protected typeOf_Type1 rule() {
        return this;
      }
  ...
  public ExpectType_typeOf_Type(RuleTable ruleTable) {
    super(ruleTable, "typeOf_Type", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(NewLanguage.types)/813836719655367383"));
  }

  @Override
  public SAbstractConcept applicableConcept() {
    return CONCEPTS.ConstantLanguageType$iZ;
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept ConstantLanguageType$iZ = MetaAdapterFactory.getConcept(0xf1277323ea964c38L, 0xa5127456d3818e7aL, 0x338399ced3406bd6L, "NewLanguage.structure.ConstantLanguageType");
  }
}
