...
public class ConstantRules_binary_expr_type extends AbstractRuleTemplate<ConstantRules_binary_expr_type.Token> {
  ...
  public class Token implements RuleTemplate.Token {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new binary_expr_type() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          RuleBuilder builder = new RuleBuilder(session, "binary_expr_type", "binary_expr_type#0" + "_" + String.valueOf(token().bin.getNodeId()).replaceAll("~", "_"), getTemplateRef(), token().bin, SNodeOperations.getPointer(token().bin));
          ...
          builder.appendGuard(new PredicateBuilder(LogicalPredicate.BOUND_SYM).withArguments(rule().LeftType).toPredicate());
          builder.appendGuard(new PredicateBuilder(LogicalPredicate.BOUND_SYM).withArguments(rule().RightType).toPredicate());
          builder.appendGuard(new PredicateBuilder(UnificationPredicate.UNI_SYM).withArguments(rule().LeftType, rule().RightType).toPredicate());
      ...
      new binary_expr_type1() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          RuleBuilder builder = new RuleBuilder(session, "binary_expr_type", "binary_expr_type#1" + "_" + String.valueOf(token().bin.getNodeId()).replaceAll("~", "_"), getTemplateRef(), token().bin, SNodeOperations.getPointer(token().bin));
    ...
    public abstract class binary_expr_type1 implements ConstraintRuleTemplate {

      protected binary_expr_type1 rule() {
        return this;
      }
  ...
  public ConstantRules_binary_expr_type(RuleTable ruleTable) {
