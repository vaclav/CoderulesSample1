...
public class ExpectType_typeOf_FunctionDefinition extends AbstractRuleTemplate<ExpectType_typeOf_FunctionDefinition.Token> {
  ...
  public class Token implements RuleTemplate.Token {
    ...
    public Iterable<RuleBuilder> apply() {
      ...
      new typeOf_FunctionDefinition() {
        ...
        public void apply(TemplateApplicationSession session) {
          ...
          RuleBuilder builder = new RuleBuilder(session, "typeOf_FunctionDefinition", "typeOf_FunctionDefinition#0" + "_" + String.valueOf(token().fun.getNodeId()).replaceAll("~", "_"), getTemplateRef(), token().fun, SNodeOperations.getPointer(token().fun));
          ...
          builder.appendHeadKept(new ConstraintBuilder(new ConstraintSymbol("typeOf", 2)).withArguments(token().fun, rule().TypeTerm).toConstraint());
          ...
          builder.appendBody(new PredicateBuilder(EvalExpressionPredicate.EVAL_SYM).withArguments(new LateExpression<Object>() {
            public Object[] metaArgs() {
              return new Object[]{rule().TypeCollector, rule().TypeNode, token().fun};
            }
      ...
      new typeOf_FunctionDefinition1() {
        @Override
        public void apply(TemplateApplicationSession session) {
          TypeCollector = MetaLogicalFactory.metaLogical("TypeCollector", BiConsumer.class);
          TypeNode = MetaLogicalFactory.metaLogical("TypeNode", SNode.class);
          ...
          RuleBuilder builder = new RuleBuilder(session, "typeOf_FunctionDefinition", "typeOf_FunctionDefinition#1" + "_" + String.valueOf(token().fun.getNodeId()).replaceAll("~", "_"), getTemplateRef(), token().fun, SNodeOperations.getPointer(token().fun));

          builder.appendHeadReplaced(new ConstraintBuilder(new ConstraintSymbol("expectType", 2)).withArguments(token().fun, rule().TypeCollector).toConstraint());
          builder.appendHeadKept(new ConstraintBuilder(new ConstraintSymbol("typeOf", 2)).withArguments(token().fun, rule().TypeTerm).toConstraint());
          builder.appendBody(new ConstraintBuilder(new ConstraintSymbol("recover", 2)).withArguments(rule().TypeNode, rule().TypeTerm).toConstraint());
          builder.appendBody(new PredicateBuilder(EvalExpressionPredicate.EVAL_SYM).withArguments(new LateExpression<Object>() {
            public Object[] metaArgs() {
    ...
    public abstract class typeOf_FunctionDefinition implements ConstraintRuleTemplate {

      protected typeOf_FunctionDefinition rule() {
        return this;
      }
    ...
    public abstract class typeOf_FunctionDefinition1 implements ConstraintRuleTemplate {

      protected typeOf_FunctionDefinition1 rule() {
        return this;
      }
  ...
  public ExpectType_typeOf_FunctionDefinition(RuleTable ruleTable) {
    super(ruleTable, "typeOf_FunctionDefinition", SNodePointer.deserialize("r:9e6cb41b-3b70-499a-8027-e5d416a03df7(NewLanguage.types)/813836719654302849"));
  }
